...
export default class PanelSettings extends React.Component<IPanelSettingsProps,IPanelSettingsState>{
  ...
  {
    let contentURL = `${this.props.webPartContext.pageContext.web.absoluteUrl}/Lists/GoalSecurityAddGoal/AllItems.aspx`
    let body: any = {      
  ...
  {
    let contentURL = `${this.props.webPartContext.pageContext.web.absoluteUrl}/Lists/GoalDepartmentOptions/AllItems.aspx`
    let body: any = {      
