define([], function() {
  return {
    ...
    LocationListName: "List Name for Location",
    AreaListName: "List Name for Area",
    CategoryListName: "List Name for Category",
    MasterListName: "List Name for Master",
    CalendarListName: "Calendar List name",
