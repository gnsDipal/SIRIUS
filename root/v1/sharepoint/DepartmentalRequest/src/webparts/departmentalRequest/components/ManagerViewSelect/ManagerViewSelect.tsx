...
export default class ManagerViewSelect extends React.Component<IManagerViewSelectProps, IManagerViewSelectState> {
 ...
 private initialDeptGetMethod() {
  ...
  this.props.spHttpClient
    .get(`${this.props.webUrl}/_api/web/lists/GetByTitle('EmpReq')/items?$select=*,DepartmentManager/Title,AttachmentFiles&$expand=DepartmentManager,AttachmentFiles&$filter=DepartmentManagerId eq ${this.props.currentUserId} &$orderby=ID desc`,
      ...
      { (this.state.openRequestsCount === this.state.raisedRequestsDepts.length) && (this.state.inProcessRequestsCount === this.state.raisedRequestsDepts.length) && (this.state.closedRequestsCount === this.state.raisedRequestsDepts.length) && (this.state.unlockEachPlaceCard === 0) && (this.state.homeButtonUnlock === 0) &&
       <div className="ms-Grid">
            ...
            
        {
            ...
            <ManagerView webPartContext={this.props.webPartContext} passedDept={this.state.passDeptName} passedStatus={this.state.passStatus}  msGraphClientFactory={this.props.msGraphClientFactory} emailType={this.props.emailType} description={this.props.description} loggedInUserEmail={this.props.loggedInUserEmail} loggedInUserName={this.props.loggedInUserName} spHttpClient={this.props.spHttpClient} webUrl={this.props.webUrl} currentUserId={this.props.currentUserId}/>
        }
