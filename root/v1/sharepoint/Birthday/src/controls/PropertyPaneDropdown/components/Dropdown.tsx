...
export default class AsyncDropdown extends React.Component<IDropdownProps, IDropdownState> {
  ...
  private loadOptions(): void {
    ...
    this.props.loadOptions()
      .then((options: IDropdownOption[]): void => {
        ...
        this.setState((prevState: IDropdownState, props: IDropdownProps): IDropdownState => {
