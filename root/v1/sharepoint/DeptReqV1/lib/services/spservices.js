    ...
    spservices.prototype.onInit = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                Logger.write("spServices init()", 1 /* Info */);
                return [2 /*return*/];
            });
        });
    };
    spservices.prototype.checkLoggedInUserAsAdmin = function () {
        var headers = new Headers();
        // suppress metadata to minimize the amount of data loaded from SharePoint
        headers.append("accept", "application/json;odata.metadata=none");
        this.webContext.spHttpClient
            .get(this.webContext.pageContext.web.absoluteUrl + "/_api/web/currentuser/issiteadmin", SPHttpClient.configurations.v1, {
            headers: headers
        })
            .then(function (res) {
            return res.json();
