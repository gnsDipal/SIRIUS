...
var SPMyRequestService = /** @class */ (function () {
    function SPMyRequestService(context) {
    ...
    SPMyRequestService.prototype.onInit = function () {
    ...
    SPMyRequestService.prototype.loadMyRequestsViewCount = function () {
        return __awaiter(this, void 0, void 0, function () {
            var myRequestedDepartmentsCount, web, result, tempArr, i, data_1, promiseOpenRequestCount, promiseInProcessRequestCount, promiseClosedRequestsCount, i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        uniqueDeptList = [];
                        web = Web(this.webUrl);
                        return [4 /*yield*/, web.lists.getByTitle('EmpReq').items.select('*', 'AttachmentFiles').expand('AttachmentFiles').filter("Author eq " + this.loggedInUserId).orderBy("ID", false).get()];
                    case 1:
                        result = _a.sent();
    ...
    SPMyRequestService.prototype.getRequestedCountByPara = function (web, deptName, status, currentUserId) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SPMyRequestService.prototype.loadDeptListInfo = function (selectedStatus, dept) {
        return __awaiter(this, void 0, void 0, function () {
            var myReqData, result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    return SPMyRequestService;
}()); //End of Main class
export default SPMyRequestService;
//# sourceMappingURL=SPMyRequestService.js.map