 ...
 */
(function () {
    var placeholderClassName = "placeholder" + Math.random().toString().substr(2, 8);
    ...
    function addPlaceholder(ev) {
        ...
        var dataValue = ev.data ? ev.data.dataValue : '';
        if (root && placeholder && isTextEmpty(root.getText()) && dataValue.length === 0) {
