...
import { CanvasControlType } from '@ms/sp-canvas-read';
...
import * as strings from './SerializedCanvasView.resx';
            ...
            React.createElement("div", null,
                React.createElement(Pivot, null,
                    ...
                    React.createElement(PivotItem, { linkText: strings.ClassicPages },
                        React.createElement("div", { className: styles.pivotItem }, webpartDataCollection.map(function (webpartData) { return (React.createElement(SerializedWebPart, { key: webpartData.instanceId, serializedWebPart: webpartData })); })))),
                React.createElement(Link, __assign({ className: styles.learnMoreLink }, {
