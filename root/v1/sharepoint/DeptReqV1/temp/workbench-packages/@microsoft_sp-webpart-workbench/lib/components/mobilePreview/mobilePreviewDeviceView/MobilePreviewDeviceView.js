...
var MobilePreviewDeviceView = /** @class */ (function (_super) {
    ...
    MobilePreviewDeviceView.prototype.render = function () {
        ...
        var mobilePreviewClassName = css(styles.mobilePreviewDevice, this.props.deviceType === DeviceType.Tablet
            ? styles.mobilePreviewTablet
            : this.props.currentOrientation === DeviceOrientation.Portrait
                ? styles.mobilePreviewPortrait
