...
var Goal = function (props) {
    ...
    var handleSectorTabHeaderChange = function (id) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            props.handleMainSectorChange(id);
            return [2 /*return*/];
        });
    }); };
    return (React.createElement("div", { className: styles.goal },
        React.createElement(GoalItem, __assign({ handleSectorChange: handleSectorTabHeaderChange }, props))));
};
export default Goal;
